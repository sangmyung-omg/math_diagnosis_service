...
CREATE TABLE USER_EXAM_CARD(
    ...
    TYPE_ID          NUMBER          NULL, 
    CONSTRAINT PK_USER_EXAM_CARD PRIMARY KEY (CARD_ID)
);

ALTER TABLE USER_EXAM_CARD
    ADD CONSTRAINT FK_USER_EXAM_CARD_USER FOREIGN KEY (USER_UUID)
        REFERENCES USER_MASTER (USER_UUID);


ALTER TABLE USER_EXAM_CARD
    ADD CONSTRAINT FK_USER_EXAM_CARD_TYPE FOREIGN KEY (TYPE_ID)
        REFERENCES PROBLEM_TYPE_MASTER (TYPE_ID);


ALTER TABLE USER_EXAM_CARD
    ADD CONSTRAINT FK_USER_EXAM_CARD_SECT FOREIGN KEY (SECTION_ID)
        REFERENCES CURRICULUM_MASTER (CURRICULUM_ID);
...
ALTER TABLE EXAM_CARD_PROBLEM
    ADD CONSTRAINT FK_EXAM_CARD_PROBLEM_CARD_ID_U FOREIGN KEY (CARD_ID)
        REFERENCES USER_EXAM_CARD_ (CARD_ID);
