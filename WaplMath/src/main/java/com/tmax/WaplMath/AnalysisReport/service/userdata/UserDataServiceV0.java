        ...
        List<UserStudyDataDTO> result = 
            userIDList.stream()
                      ...
                      .map(id -> {
                            ...
                            int totalcnt = correctRate.getProblemcount();
                            int correct = (int)(correctRate.getCorrectrate() * correctRate.getProblemcount());
                            int wrong = correctRate.getProblemcount() - correct;
