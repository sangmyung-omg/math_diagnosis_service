...
public interface UserExamCurriculumLogRepository extends CrudRepository<UserExamCurriculumLogDAO, String> {
	...
	List<UserExamCurriculumLogDAO> findAllByRecommendedDate(@Param("userUuid") String userUuid,
	...
	List<UserKnowledgeDAO> findAllLowMasteryUkUuid(@Param("userUuid") String userUuid,
